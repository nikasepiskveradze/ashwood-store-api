...
export class CreateProductTable1694330037413 implements MigrationInterface {
  name = 'CreateProductTable1694330037413';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "product" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "short" character varying NOT NULL, "long" character varying NOT NULL, "quantity" integer NOT NULL, "price" integer NOT NULL, "image" character varying NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
